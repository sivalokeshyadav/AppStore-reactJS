...
class AppStore extends Component {
  ...
  getFilteredItems = searchedApps => {
    const {activeId} = this.state
    const filteredItems = searchedApps.filter(
      eachItemDetails => eachItemDetails.category === activeId,
    )
  ...
  getSearchResults = () => {
    ...
    const filteredSearches = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const filteredItems = this.getFilteredItems(searchResults)
